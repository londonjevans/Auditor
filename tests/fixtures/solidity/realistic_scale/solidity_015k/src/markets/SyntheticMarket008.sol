...
abstract contract SyntheticMarket008 is SyntheticAccounting, ISyntheticScaleMarket {
    bytes32 public constant MARKET_ID = keccak256("mmaudit-synthetic-market-008");
    ...
    function riskWindow00(
        ...
        adjustedAssets = assets + assets * 9 / 10_000;
    }
