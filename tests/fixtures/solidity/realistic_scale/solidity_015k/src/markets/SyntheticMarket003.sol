...
abstract contract SyntheticMarket003 is SyntheticAccounting, ISyntheticScaleMarket {
    bytes32 public constant MARKET_ID = keccak256("mmaudit-synthetic-market-003");
    ...
    function riskWindow00(
        ...
        adjustedAssets = assets + assets * 4 / 10_000;
    }
