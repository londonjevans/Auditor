...
abstract contract SyntheticMarket007 is SyntheticAccounting, ISyntheticScaleMarket {
    bytes32 public constant MARKET_ID = keccak256("mmaudit-synthetic-market-007");
    ...
    function riskWindow00(
        ...
        adjustedAssets = assets + assets * 8 / 10_000;
    }
