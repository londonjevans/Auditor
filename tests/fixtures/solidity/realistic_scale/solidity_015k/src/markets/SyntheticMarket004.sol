...
abstract contract SyntheticMarket004 is SyntheticAccounting, ISyntheticScaleMarket {
    bytes32 public constant MARKET_ID = keccak256("mmaudit-synthetic-market-004");
    ...
    function riskWindow00(
        ...
        adjustedAssets = assets + assets * 5 / 10_000;
    }
