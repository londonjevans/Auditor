...
abstract contract SyntheticMarket041 is SyntheticAccounting, ISyntheticScaleMarket {
    bytes32 public constant MARKET_ID = keccak256("mmaudit-synthetic-market-041");
    ...
    function riskWindow07(
        ...
        adjustedAssets = assets + assets * 49 / 10_000;
    }
