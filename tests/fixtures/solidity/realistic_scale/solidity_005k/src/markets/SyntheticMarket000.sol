...
abstract contract SyntheticMarket000 is SyntheticAccounting, ISyntheticScaleMarket {
    bytes32 public constant MARKET_ID = keccak256("mmaudit-synthetic-market-000");
    ...
    function riskWindow00(
        ...
        adjustedAssets = assets + assets * 1 / 10_000;
    }
