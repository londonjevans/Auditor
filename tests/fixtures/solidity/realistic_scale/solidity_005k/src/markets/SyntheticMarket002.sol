...
abstract contract SyntheticMarket002 is SyntheticAccounting, ISyntheticScaleMarket {
    bytes32 public constant MARKET_ID = keccak256("mmaudit-synthetic-market-002");
    ...
    function riskWindow00(
        ...
        adjustedAssets = assets + assets * 3 / 10_000;
    }
