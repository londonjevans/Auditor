...
abstract contract SyntheticMarket001 is SyntheticAccounting, ISyntheticScaleMarket {
    bytes32 public constant MARKET_ID = keccak256("mmaudit-synthetic-market-001");
    ...
    function riskWindow00(
        ...
        adjustedAssets = assets + assets * 2 / 10_000;
    }
