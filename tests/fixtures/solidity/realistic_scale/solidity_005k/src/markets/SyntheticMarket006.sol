...
abstract contract SyntheticMarket006 is SyntheticAccounting, ISyntheticScaleMarket {
    bytes32 public constant MARKET_ID = keccak256("mmaudit-synthetic-market-006");
    ...
    function riskWindow00(
        ...
        adjustedAssets = assets + assets * 7 / 10_000;
    }
