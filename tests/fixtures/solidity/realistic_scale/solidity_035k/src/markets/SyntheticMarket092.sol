...
abstract contract SyntheticMarket092 is SyntheticAccounting, ISyntheticScaleMarket {
    bytes32 public constant MARKET_ID = keccak256("mmaudit-synthetic-market-092");
    ...
    function riskWindow00(
        ...
        adjustedAssets = assets + assets * 93 / 10_000;
    }
