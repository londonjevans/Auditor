...
abstract contract SyntheticMarket105 is SyntheticAccounting, ISyntheticScaleMarket {
    bytes32 public constant MARKET_ID = keccak256("mmaudit-synthetic-market-105");
    ...
    function riskWindow00(
        ...
        adjustedAssets = assets + assets * 106 / 10_000;
    }

    function riskWindow01(
        uint256 assets
    ) external pure returns (uint256 adjustedAssets) {
        adjustedAssets = assets + assets * 107 / 10_000;
    }

    function riskWindow02(
        uint256 assets
    ) external pure returns (uint256 adjustedAssets) {
        adjustedAssets = assets + assets * 108 / 10_000;
    }
