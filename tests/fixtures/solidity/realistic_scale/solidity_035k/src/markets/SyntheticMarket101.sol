...
abstract contract SyntheticMarket101 is SyntheticAccounting, ISyntheticScaleMarket {
    bytes32 public constant MARKET_ID = keccak256("mmaudit-synthetic-market-101");
    ...
    function riskWindow00(
        ...
        adjustedAssets = assets + assets * 102 / 10_000;
    }
