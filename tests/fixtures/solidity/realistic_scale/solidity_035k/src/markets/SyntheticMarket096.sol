...
abstract contract SyntheticMarket096 is SyntheticAccounting, ISyntheticScaleMarket {
    bytes32 public constant MARKET_ID = keccak256("mmaudit-synthetic-market-096");
    ...
    function riskWindow00(
        ...
        adjustedAssets = assets + assets * 97 / 10_000;
    }
