...
abstract contract SyntheticMarket028 is SyntheticAccounting, ISyntheticScaleMarket {
    bytes32 public constant MARKET_ID = keccak256("mmaudit-synthetic-market-028");
    ...
    function riskWindow00(
        ...
        adjustedAssets = assets + assets * 29 / 10_000;
    }

    function riskWindow01(
        uint256 assets
    ) external pure returns (uint256 adjustedAssets) {
        adjustedAssets = assets + assets * 30 / 10_000;
    }

    function riskWindow02(
        uint256 assets
    ) external pure returns (uint256 adjustedAssets) {
        adjustedAssets = assets + assets * 31 / 10_000;
    }

    function riskWindow03(
        uint256 assets
    ) external pure returns (uint256 adjustedAssets) {
        adjustedAssets = assets + assets * 32 / 10_000;
    }

    function riskWindow04(
        uint256 assets
    ) external pure returns (uint256 adjustedAssets) {
        adjustedAssets = assets + assets * 33 / 10_000;
    }

    function riskWindow05(
        uint256 assets
    ) external pure returns (uint256 adjustedAssets) {
        adjustedAssets = assets + assets * 34 / 10_000;
    }

    function riskWindow06(
        uint256 assets
    ) external pure returns (uint256 adjustedAssets) {
        adjustedAssets = assets + assets * 35 / 10_000;
    }

    function riskWindow07(
        uint256 assets
    ) external pure returns (uint256 adjustedAssets) {
        adjustedAssets = assets + assets * 36 / 10_000;
    }

    function riskWindow08(
        uint256 assets
    ) external pure returns (uint256 adjustedAssets) {
        adjustedAssets = assets + assets * 37 / 10_000;
    }

    function riskWindow09(
        uint256 assets
    ) external pure returns (uint256 adjustedAssets) {
        adjustedAssets = assets + assets * 38 / 10_000;
    }

    function riskWindow10(
        uint256 assets
    ) external pure returns (uint256 adjustedAssets) {
        adjustedAssets = assets + assets * 39 / 10_000;
    }

    function riskWindow11(
        uint256 assets
    ) external pure returns (uint256 adjustedAssets) {
        adjustedAssets = assets + assets * 40 / 10_000;
    }
