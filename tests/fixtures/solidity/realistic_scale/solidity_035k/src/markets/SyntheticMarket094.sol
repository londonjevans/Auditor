...
abstract contract SyntheticMarket094 is SyntheticAccounting, ISyntheticScaleMarket {
    bytes32 public constant MARKET_ID = keccak256("mmaudit-synthetic-market-094");
    ...
    function riskWindow00(
        ...
        adjustedAssets = assets + assets * 95 / 10_000;
    }
