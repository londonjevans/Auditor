...
abstract contract SyntheticMarket088 is SyntheticAccounting, ISyntheticScaleMarket {
    bytes32 public constant MARKET_ID = keccak256("mmaudit-synthetic-market-088");
    ...
    function riskWindow00(
        ...
        adjustedAssets = assets + assets * 89 / 10_000;
    }
