...
abstract contract SyntheticMarket093 is SyntheticAccounting, ISyntheticScaleMarket {
    bytes32 public constant MARKET_ID = keccak256("mmaudit-synthetic-market-093");
    ...
    function riskWindow00(
        ...
        adjustedAssets = assets + assets * 94 / 10_000;
    }
