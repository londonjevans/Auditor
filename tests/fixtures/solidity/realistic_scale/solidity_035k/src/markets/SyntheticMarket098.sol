...
abstract contract SyntheticMarket098 is SyntheticAccounting, ISyntheticScaleMarket {
    bytes32 public constant MARKET_ID = keccak256("mmaudit-synthetic-market-098");
    ...
    function riskWindow00(
        ...
        adjustedAssets = assets + assets * 99 / 10_000;
    }
