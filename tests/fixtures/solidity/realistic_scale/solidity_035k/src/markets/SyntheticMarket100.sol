...
abstract contract SyntheticMarket100 is SyntheticAccounting, ISyntheticScaleMarket {
    bytes32 public constant MARKET_ID = keccak256("mmaudit-synthetic-market-100");
    ...
    function riskWindow00(
        ...
        adjustedAssets = assets + assets * 101 / 10_000;
    }
