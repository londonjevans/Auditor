...
abstract contract SyntheticMarket097 is SyntheticAccounting, ISyntheticScaleMarket {
    bytes32 public constant MARKET_ID = keccak256("mmaudit-synthetic-market-097");
    ...
    function riskWindow00(
        ...
        adjustedAssets = assets + assets * 98 / 10_000;
    }
