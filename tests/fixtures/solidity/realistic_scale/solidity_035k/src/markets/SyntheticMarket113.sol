...
abstract contract SyntheticMarket113 is SyntheticAccounting, ISyntheticScaleMarket {
    bytes32 public constant MARKET_ID = keccak256("mmaudit-synthetic-market-113");
    ...
    function riskWindow00(
        ...
        adjustedAssets = assets + assets * 114 / 10_000;
    }

    function riskWindow01(
        uint256 assets
    ) external pure returns (uint256 adjustedAssets) {
        adjustedAssets = assets + assets * 115 / 10_000;
    }

    function riskWindow02(
        uint256 assets
    ) external pure returns (uint256 adjustedAssets) {
        adjustedAssets = assets + assets * 116 / 10_000;
    }

    function riskWindow03(
        uint256 assets
    ) external pure returns (uint256 adjustedAssets) {
        adjustedAssets = assets + assets * 117 / 10_000;
    }

    function riskWindow04(
        uint256 assets
    ) external pure returns (uint256 adjustedAssets) {
        adjustedAssets = assets + assets * 118 / 10_000;
    }

    function riskWindow05(
        uint256 assets
    ) external pure returns (uint256 adjustedAssets) {
        adjustedAssets = assets + assets * 119 / 10_000;
    }

    function riskWindow06(
        uint256 assets
    ) external pure returns (uint256 adjustedAssets) {
        adjustedAssets = assets + assets * 120 / 10_000;
    }

    function riskWindow07(
        uint256 assets
    ) external pure returns (uint256 adjustedAssets) {
        adjustedAssets = assets + assets * 121 / 10_000;
    }

    function riskWindow08(
        uint256 assets
    ) external pure returns (uint256 adjustedAssets) {
        adjustedAssets = assets + assets * 122 / 10_000;
    }

    function riskWindow09(
        uint256 assets
    ) external pure returns (uint256 adjustedAssets) {
        adjustedAssets = assets + assets * 123 / 10_000;
    }

    function riskWindow10(
        uint256 assets
    ) external pure returns (uint256 adjustedAssets) {
        adjustedAssets = assets + assets * 124 / 10_000;
    }

    function riskWindow11(
        uint256 assets
    ) external pure returns (uint256 adjustedAssets) {
        adjustedAssets = assets + assets * 125 / 10_000;
    }
