...
abstract contract SyntheticMarket005 is SyntheticAccounting, ISyntheticScaleMarket {
    bytes32 public constant MARKET_ID = keccak256("mmaudit-synthetic-market-005");
    ...
    function riskWindow00(
        ...
        adjustedAssets = assets + assets * 6 / 10_000;
    }
