...
abstract contract SyntheticMarket091 is SyntheticAccounting, ISyntheticScaleMarket {
    bytes32 public constant MARKET_ID = keccak256("mmaudit-synthetic-market-091");
    ...
    function riskWindow00(
        ...
        adjustedAssets = assets + assets * 92 / 10_000;
    }
