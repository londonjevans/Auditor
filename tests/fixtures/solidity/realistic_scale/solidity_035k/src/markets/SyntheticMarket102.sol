...
abstract contract SyntheticMarket102 is SyntheticAccounting, ISyntheticScaleMarket {
    bytes32 public constant MARKET_ID = keccak256("mmaudit-synthetic-market-102");
    ...
    function riskWindow00(
        ...
        adjustedAssets = assets + assets * 103 / 10_000;
    }

    function riskWindow01(
        uint256 assets
    ) external pure returns (uint256 adjustedAssets) {
        adjustedAssets = assets + assets * 104 / 10_000;
    }
