...
abstract contract SyntheticMarket099 is SyntheticAccounting, ISyntheticScaleMarket {
    bytes32 public constant MARKET_ID = keccak256("mmaudit-synthetic-market-099");
    ...
    function riskWindow00(
        ...
        adjustedAssets = assets + assets * 100 / 10_000;
    }
