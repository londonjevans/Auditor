...
abstract contract SyntheticMarket089 is SyntheticAccounting, ISyntheticScaleMarket {
    bytes32 public constant MARKET_ID = keccak256("mmaudit-synthetic-market-089");
    ...
    function riskWindow00(
        ...
        adjustedAssets = assets + assets * 90 / 10_000;
    }
