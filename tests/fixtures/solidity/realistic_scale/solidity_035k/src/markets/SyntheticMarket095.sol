...
abstract contract SyntheticMarket095 is SyntheticAccounting, ISyntheticScaleMarket {
    bytes32 public constant MARKET_ID = keccak256("mmaudit-synthetic-market-095");
    ...
    function riskWindow00(
        ...
        adjustedAssets = assets + assets * 96 / 10_000;
    }
