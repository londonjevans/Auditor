...
abstract contract SyntheticMarket049 is SyntheticAccounting, ISyntheticScaleMarket {
    bytes32 public constant MARKET_ID = keccak256("mmaudit-synthetic-market-049");
    ...
    function riskWindow00(
        ...
        adjustedAssets = assets + assets * 50 / 10_000;
    }

    function riskWindow01(
        uint256 assets
    ) external pure returns (uint256 adjustedAssets) {
        adjustedAssets = assets + assets * 51 / 10_000;
    }

    function riskWindow02(
        uint256 assets
    ) external pure returns (uint256 adjustedAssets) {
        adjustedAssets = assets + assets * 52 / 10_000;
    }

    function riskWindow03(
        uint256 assets
    ) external pure returns (uint256 adjustedAssets) {
        adjustedAssets = assets + assets * 53 / 10_000;
    }

    function riskWindow04(
        uint256 assets
    ) external pure returns (uint256 adjustedAssets) {
        adjustedAssets = assets + assets * 54 / 10_000;
    }

    function riskWindow05(
        uint256 assets
    ) external pure returns (uint256 adjustedAssets) {
        adjustedAssets = assets + assets * 55 / 10_000;
    }

    function riskWindow06(
        uint256 assets
    ) external pure returns (uint256 adjustedAssets) {
        adjustedAssets = assets + assets * 56 / 10_000;
    }

    function riskWindow07(
        uint256 assets
    ) external pure returns (uint256 adjustedAssets) {
        adjustedAssets = assets + assets * 57 / 10_000;
    }

    function riskWindow08(
        uint256 assets
    ) external pure returns (uint256 adjustedAssets) {
        adjustedAssets = assets + assets * 58 / 10_000;
    }

    function riskWindow09(
        uint256 assets
    ) external pure returns (uint256 adjustedAssets) {
        adjustedAssets = assets + assets * 59 / 10_000;
    }

    function riskWindow10(
        uint256 assets
    ) external pure returns (uint256 adjustedAssets) {
        adjustedAssets = assets + assets * 60 / 10_000;
    }

    function riskWindow11(
        uint256 assets
    ) external pure returns (uint256 adjustedAssets) {
        adjustedAssets = assets + assets * 61 / 10_000;
    }
