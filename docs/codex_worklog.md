...
- **Checkpoint:** Local source checkpoint `f8960d92569cb9d8865ada9284981458699e4dab`
  ...
  remote-resolved on `origin/agent/v3-wip-checkpoint`. The follow-up custody record remains local
  pending explicit approval; `.gitignore` remains an unrelated unstaged user edit.
