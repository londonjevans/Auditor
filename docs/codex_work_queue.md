...
Latest operator report labelled `2026-09-08T20:37Z` reports the first completed development candidate-plus-two-reviewer ensemble on the planted corpus, after an incomplete candidate attempt, and a guarded-corpus run with two of three stages observed before review-02/file-01 timed out. These are nonauthorizing operator observations, not independently authenticated private execution, genuine root independence, semantic truth or a qualified completed audit.

Report ef504ac0255ab6129294f49fe50d10df17bb4762a0606db83cfca0fb43f8533f / 265513 bytes / 4489 lines, latest label 2026-09-08T20:37Z. Reports ledger#3 now63 entries/59 reconciled/four uncertain; development USD1.221975476 and uncertain USD1.774773176. Cumulative57/USD0.68118684 and real audits0 remain reported unchanged. Preserve the incomplete candidate, missing guarded reviewer and every uncertain liability; neither timeout nor absent usage establishes zero charge.

Reported arithmetic is consistent: three charged totals add USD0.14729396, seventeen requests add sixteen reconciled/one uncertain entry, and USD0.1877874 new uncertainty raises USD1.586985776 to USD1.774773176. The completed run's three stage costs sum to USD0.0677264. One small planted control with unanimous support is not observed negative-control discrimination or evidence that the architecture beats concentrated compute. The source has a separate180s per-request cap; this does not prove a provider/route cause or that increasing time or retrying would succeed. The earlier forced-token-equality explanation remains unadopted: candidate and review allowances are independently selected and exact estimates can refuse separately. No private bytes were inspected; report-file rerun, role and timeout requests are not execution authority.

The20:41 addendum reports a separately rerun guarded ensemble completing with two candidate advisories/four review opinions, one SUPPORTED and one INCONCLUSIVE consensus, costUSD0.04564604/wall129s; refutations remain0. It does not revise the earlier63-entry ledger or development/uncertain aggregate headers. Do not silently relabel those earlier snapshots as post-addendum totals. Adding the new charged amount to the earlier reported development subtotal would yieldUSD1.267621516 arithmetically, not authenticated billing; the original timeout/uncertain liability remains. The completed a/b pair costsUSD0.11337244 but excludes preceding failed runs. Separate rerun success does not prove an automatic retry, same-candidate replay or underlying route diagnosis.

V3-DEVENSEMBLE-001 is locally COMPLETE and its tested source 51d5981c3b69c67328e9dc2ace08ab20ee125ed0 is pushed to origin/agent/v3-wip-checkpoint and independently remote-verified. Exact30 paths match manifestd9bde81f on preserved operator-only parentf621dcd. Development1435, strict-cost856 plus resolved local HTTP1, terminal352 and closed-record191 checks pass, with all200 new regressions, full Ruff799/mypy269/canonical/governance and23 exact compatibility hashes. Original candidates, both opinions, every missing/failed stage and unique costs remain visible. This is not a paid run, verified independent-root decision, deployment or completion of the qualified ensemble objective.
