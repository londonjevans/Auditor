...
V3-CONTROLMEASURE-001 is PARTIAL and ready for the explicitly requested tested publication. The separate automatic/offline control-measurement sidecar treats category/kind as annotations while preserving exact legacy scores, original labels, all claims and liabilities. Corpus1391, strict930 plus exact resolved localhost1, corrected terminal474 and unchanged exclusive release44 checks pass:2840distinct identities. Full static/canonical checks,152previous schemas and23legacy hashes pass. Expanded new-artifact128MB/old32/96MBreader acceptance and explicit maximum-sidecar assertions remain; next engineering is this same ticket. Report68b6f498/07:24Z remains nonauthorizing and its private inputs uninspected, with9authorities false,real audits0 and CI manual-only. Publication is selected, not yet claimed; no provider/paid command, legacy rewrite, qualification, deployment or second capability. Older publication paragraphs below are historical checkpoint receipts.
...
- **Next action:** Publish only this tested PARTIAL checkpoint under the direct user request, then continue V3-CONTROLMEASURE-001 with dedicated new128MB/old32/96MBreader boundaries, explicit maximum-sidecar assertions and unmatched-weight policy wording before full acceptance. Preserve every legacy result/label/liability and strict custody default. Private scoring, semantic adjudication, repeat-N studies, review recovery and qualification remain separate; no paid/provider command or second capability.
