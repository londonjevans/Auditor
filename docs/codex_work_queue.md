...
Latest operator report labelled `2026-09-08T15:43Z` reports two complete provider-free comparison artifacts for the retained kimi/glm runs: one shared planted root and none on the guarded corpus, 6/6 first-attempt shards each, summed costs USD 0.09696004 and USD 0.11351168. Those sums match the previously reported individual run costs. The operator accepts the artifacts' descriptive-only, non-ensemble labels, unestablished lineage/request-budget parity and unevaluated superiority. This is operator-supplied evidence, not independent inspection or authentication of private files. A historical lineage assertion does not update the revoked active selection or establish comparison authority.

Exact report `e2195991e18b5d88648d625fc0d5f8176a5749fc01c26e8547d3834cb00c3b6e` (242614 bytes / 4168 lines) preserves all prior history. Reported actual development remains USD 0.802410772, ledger #3 21 entries / USD 0.541770772 and uncertain reservations USD 0.4064568. Cumulative 57 entries / USD 0.68118684 and completed real audits 0 remain separate and unchanged. Missing generation/charge evidence does not prove free requests; prior incomplete deepseek attempts and missing token evidence remain unresolved. Local truth is one planted root and its guarded counterpart, not two independent planted roots.

V3-DEVCOMPARE-001 is locally COMPLETE and its tested source is published as 497b669423bb04ee049adee7130730a465a73637, tree c3964855cfe12ba539ae3b405b8f63f3bb100485. The non-force push to origin/agent/v3-wip-checkpoint is independently confirmed by exact remote SHA readback; operator-report ancestors aa81452 and 9b77bc3 are preserved. Fresh checks pass 871 development / 333 acceptance / 191 precommit, with 101 new regressions and all 23 compatibility hashes unchanged. Only current guidance/coordination records carry this result-only publication receipt; runtime/test/schema/inventory bytes remain exact. Active plan 4e7fff76 and all authority fields are unchanged; DEVTRIAL remains PARTIAL, and DEVSCHALIGN/DEVDECODE/DEVBENCH remain locally COMPLETE. No paid rerun, private-input access, billing settlement, retry, effort/enumeration change, route/lineage adoption, second capability or release is selected. Both workflows remain manual-only.
...
- **Next action:** Keep DEVTRIAL PARTIAL for the recorded empirical gaps; do not infer missing
  runtime, request-byte freshness or validated invariant discrimination. DEVBENCH is locally
  COMPLETE and its 13:18 operator-reported results retain incomplete guarded scope and uncertain
  costs. V3-DEVDECODE-001 now addresses the source-confirmed rejection-diagnostic gap under the
  standing user build goal. No new paid command, private-input read, billing settlement, retry,
  route adoption or qualification is selected. The earlier review remains historical evidence:
  docs/remediation/v3/development_trial_review.json.
